...
func ListTreatment_plan_show(c *gin.Context) {
	...
	entity.DB().Table("treatment_plans").
		Select("treatment_plans.id, dentists.dentist_name, patients.patient_name, treatment_plans.order_of_treatment, type_of_treatments.type_of_treatment_name, type_of_number_of_treatments.type_of_number_of_treatment_name, treatment_plans.treatment_detail, treatment_plans.treatment_time").
